...
- Bạn đã cài đặt phông chữ biểu tượng cảm xúc. Most systems come with an emoji font by default, but
...
Nếu biểu tượng không hiển thị đúng, hệ thống của bạn vẫn cấu hình sai.
Thật không may, lấy cấu hình font đúng đôi khi khó khăn. Người dùng trên Discord có thể có giúp đỡ được. If both symbols display correctly, but
...
2. Xoá tập tin Starship nhị phân.
