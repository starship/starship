...
`starship.toml` to get it to do certain things. ئەم پەڕەیە ووردەکاری زیاتر ئەدات لەسەر هەندێک لە شێوازە ڕێکخستنە پێشکەوتووترەکان کە لە Starshipـدا بەکارهاتووە.
...
بەپێچەوانەی شێلەکانی دیکە Bash هیچ چوارچێوەیەکی فەرمی preexec/precmdـی نییە.
...
`inverted` swaps the background and foreground colors. ڕیزبەندی ووشەکان لە زنجیرەکەدا گرنگ نییە.
