...
## [OneDark Powerline](./onedark-powerline.md)

This preset is a minimally modified version of [Gruvbox Rainbow](./gruvbox-rainbow.md) using the OneDark color palette from [Atom](https://atom-editor.cc/).
