[Return to Presets](./#catppuccin-split-pill)
...
- A [Nerd Font](https://www.nerdfonts.com/) installed and enabled in your terminal (uses Powerline rounded symbols `` and ``)

### Configuration

```sh
starship preset pill -o ~/.config/starship.toml
```

[Click to download TOML](/presets/toml/pill.toml){download}

<<< @/public/presets/toml/pill.toml
