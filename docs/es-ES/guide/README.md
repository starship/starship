...
<p align="center"><a href="https://starship.rs/config/"><strong>Explora la documentación de Starship&nbsp;&nbsp;▶</strong></a>
</p>
...
| Distribución                             | Repositorio                                                                              | Instrucciones                                                 |
| ---------------------------------------- | ---------------------------------------------------------------------------------------- | ------------------------------------------------------------- |
| **_Cualquiera_**                         | :                                                                                        | `cargo install starship --locked`                             |
| _Cualquiera_                             | [conda-forge](https://anaconda.org/conda-forge/starship)                                 | `conda install -c conda-forge starship`                       |
| _Cualquiera_                             | [Linuxbrew]                                                                              | `brew install starship`                                       |
| Alpine Linux 3.13+       | For elvish versions prior to v0.21.0 the config file might instead be `~/.elvish/rc.elv` | `apk add starship`                                            |
...
| Ubuntu 25.04 o más nuevo | [Ubuntu Universe]                                                                        | `apt install starship`                                        |
...
Necesitas usar [Clink](https://chrisant996.github.io/clink/clink.html) (v1.2.30+) con Cmd.
Crea un archivo en esta ruta `%LocalAppData%\clink\starship.lua` con el siguiente contenido:
...
Inicia una nueva instancia de shell, y deberías ver tu nuevo y hermoso prompt para shell.
Si está contento con los valores por defecto, ¡disfrútelos!
...
Si estás interesado en ayudar contribuyendo a Starship, por favor échale un vistazo a nuestra [Guía de Colaboración](https://github.com/starship/starship/blob/main/CONTRIBUTING.md). Además, siéntete libre de entrar en nuestro [servidor de Discord](https://discord.gg/8Jzqu3T) y di "¡Hola!". 👋
...
Este proyecto está bajo una licencia [ISC](https://github.com/starship/starship/blob/main/LICENSE).
