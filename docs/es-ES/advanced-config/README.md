...
Nota: El prompt derecho es una sola línea siguiendo la ubicación de entrada. To right align modules above the input line in a multi-line prompt, see the [`fill` module](/config/#fill).
