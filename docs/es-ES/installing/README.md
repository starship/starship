...
For most users, the instructions on [the main page](../guide/#🚀-installation) will work great. Sin embargo, para algunas plataformas más especializadas, se necesitan diferentes instrucciones.
