...
<p align="center"> Starship – это минималистичное, быстрое и очень настраиваемое приглашение ко вводу команд для любой оболочки! <br /> Пока вы работаете, в нём показывается необходимая вам информация. <p>
...
- Текущая версия Crystal (`🔮`).
- Версия пакета в текущей директории (`📦`)
  - npm (Node.js)
  - cargo (Rust)
  - poetry (Python)
  - composer (PHP)
...
- 👩‍💼 **Менеджер продукта**
  - У нас есть GitHub проект и множество неорганизованных/неприоритетизированных возможносей, а также идей, которые еще не были добавлены в issues. Starship нуждается в ком-то для управления направлением продукта!
- 👩‍🎨 **Дизайнер**
  - Нравится создавать красивые сайты? Превосходно! Мы стремимся создать красивую целевую страницу, показывающую Starship во всей его красе. Помощь с дизайном бренда Starship - отличная возможность попробовать новые идеи!
- 👩‍💻 **Разработчик на Rust**
  - Есть _много_ "лёгкой добычи", когда речь заходит о написании идиоматического Rust, проектировании эффективной архитектуры, оптимизации производительности, оптимизации кроссплатформенной сборки и многом другом! Я ([@matchai](https://github.com/matchai)) - новичок в Rust. Направьте нас в нужном направлении!
