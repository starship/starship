...
Если у вас есть пресет, которым вы хотите поделиться, пожалуйста, [отправьте PR](https://github.com/starship/starship/edit/main/docs/presets/README.md) для обновления этого файла! 😊
