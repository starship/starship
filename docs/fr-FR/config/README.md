...
Quand vous utilisez le style pwd de fish, au lieu de cacher le path qui est troqué, vous verrez un nom raccourcis de chaque dossiers basés sur le nombre établi pour l'option.
