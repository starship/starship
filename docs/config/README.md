...
| `truncate_from_repo_root` | `false`                                                                                                     | Whether or not to truncate the path starting from the root of the git repo you are currently in, with repository name being the root of displayed path. Requires 'truncate_to_repo' and 'truncation_symbol' to be defined. Does not work with fish style paths. |
