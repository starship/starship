...
| `continuation_prompt` | `[∙](bright-black) `            | Format for the continuation prompt on supporting shells.         |
| `syntax_error_prompt` | `[❯](bold purple) `             | Format for the syntax error prompt on supporting shells.         |
