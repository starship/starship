...
| `use_os_path_sep`        | `true`                                                                                                                       | Use the OS specific path separator instead of always using `/` (e.g. `\` on Windows), if `separator_symbol` is empty. |
| `separator_symbol`       | `''`                                                                                                                         | The symbol to use instead of always using `/`.                                                                        |
