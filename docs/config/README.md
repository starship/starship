...
| `truncation_width`  | `0`                                    | The display width the environment path should be truncated to. `0` means no truncation.                                                                                                                     |
...
| `truncation_width`       | `0`                                                                                                                          | The display width that the current directory should be truncated to.                                       |
