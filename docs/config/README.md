...
| `add_newline`     | `true`                         | Inserts blank line between shell prompts. For opening a new terminal and clearing the terminal, the newline is not printed for some shells (powershell, bash, zsh).              |
