...
- To customize what the right side of input gets replaced with, configure the `prompt_rps1_final` Ble.sh option. Por exemplo, para exibir o momento em que o último comando foi iniciado, você faria
