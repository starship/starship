...
| `style_success`         | `"bold green"` | O estilo a ser usado se o último comando foi bem-sucedido.                          |
| `style_failure`         | `"bold red"`   | O estilo a ser usado se o último comando falhou.                                    |
