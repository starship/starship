...
Se você tem uma personalização para compartilhar, por favor, [envie uma PR](https://github.com/starship/starship/edit/main/docs/presets/README.md) atualizando este arquivo! 😊
...
[![Captura de tela do Jetpack preset](/presets/img/jetpack.png "Click to view Jetpack preset")](./jetpack)
