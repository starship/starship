...
| `symbol`        | `'↕️  '`                     | Віддзеркалює значення параметра `style`                                       |
...
| `symbol`            | `'S '`                                                       | Віддзеркалює значення параметра `style`                                                                  |
...
| `symbol`                    | `'❌'`                                                                            | Код виходу останньої команди в hex                                                                                    |
...
>
> Незалежно від результату, який генерує команда, він виводиться в командний рядок у незміненому вигляді. This means if the output
