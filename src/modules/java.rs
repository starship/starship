...
fn format_java_version(
    ...
    VersionFormatter::format_module_version(module_name, version, version_format)
}
...
mod tests {
    ...
    fn test_format_java_version_openjdk() {
        ...
        assert_eq!(
            format_java_version("java", java_11, "v${raw}"),
            Some("v11.0.4".to_string())
        );
        assert_eq!(
            format_java_version("java", java_8, "v${raw}"),
    ...
    fn test_format_java_version_redhat() {
        ...
        assert_eq!(
            format_java_version("java", java_12, "v${raw}"),
    ...
    fn test_format_java_version_unknown() {
        ...
        assert_eq!(format_java_version("java", unknown_jre, "v${raw}"), None);
    }
