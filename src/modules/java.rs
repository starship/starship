...
///     - Current directory contains a file with a `.java`, `.class` or `.jar`
///       extension
...
/// Some Java vendors don't follow this format: "JRE (Zulu
/// 8.40.0.25-CA-linux64)").
...
mod tests {
    ...
    fn test_format_java_version_openjdk() {
        let java_8 = String::from(
            "OpenJDK 64-Bit Server VM (25.222-b10) for linux-amd64 JRE (1.8.0_222-b10), built on Jul 11 2019 10:18:43 \
             by \"openjdk\" with gcc 4.4.7 20120313 (Red Hat 4.4.7-23)",
        );
        let java_11 = String::from(
            "OpenJDK 64-Bit Server VM (11.0.4+11-post-Ubuntu-1ubuntu219.04) for linux-amd64 JRE \
             (11.0.4+11-post-Ubuntu-1ubuntu219.04), built on Jul 18 2019 18:21:46 by \"build\" with gcc 8.3.0",
        );
    ...
    fn test_format_java_version_oracle() {
        let java_8 = String::from(
            "Java HotSpot(TM) Client VM (25.65-b01) for linux-arm-vfp-hflt JRE (1.8.0_65-b17), built on Oct  6 2015 \
             16:19:04 by \"java_re\" with gcc 4.7.2 20120910 (prerelease)",
        );
        assert_eq!(format_java_version(java_8), Some(String::from("v1.8.0")));
    }
    ...
    fn test_format_java_version_redhat() {
        let java_8 = String::from(
            "OpenJDK 64-Bit Server VM (25.222-b10) for linux-amd64 JRE (1.8.0_222-b10), built on Jul 11 2019 20:48:53 \
             by \"root\" with gcc 7.3.1 20180303 (Red Hat 7.3.1-5)",
        );
        let java_12 = String::from(
            "OpenJDK 64-Bit Server VM (12.0.2+10) for linux-amd64 JRE (12.0.2+10), built on Jul 18 2019 14:41:47 by \
             \"jenkins\" with gcc 7.3.1 20180303 (Red Hat 7.3.1-5)",
        );
        assert_eq!(format_java_version(java_8), Some(String::from("v1.8.0")));
    ...
    fn test_format_java_version_zulu() {
        ...
        let java_8 = String::from(
            "OpenJDK 64-Bit Server VM (25.222-b10) for linux-amd64 JRE (Zulu 8.40.0.25-CA-linux64) (1.8.0_222-b10), \
             built on Jul 11 2019 11:36:39 by \"zulu_re\" with gcc 4.4.7 20120313 (Red Hat 4.4.7-3)",
        );
