...
set STARSHIP_PRECMD = 'set STARSHIP_CMD_STATUS = $status;set STARSHIP_PATH = ::STARSHIP::;set STARSHIP_END_TIME = `$STARSHIP_PATH time`;set STARSHIP_DURATION = 0;if ( $STARSHIP_START_TIME != -1 ) @ STARSHIP_DURATION = $STARSHIP_END_TIME - $STARSHIP_START_TIME;set prompt = "`($STARSHIP_PATH prompt --status $STARSHIP_CMD_STATUS --cmd-duration $STARSHIP_DURATION)`";set STARSHIP_START_TIME = -1;$USER_PRECMD;';
set STARSHIP_POSTCMD = 'set STARSHIP_START_TIME = `(::STARSHIP:: time)`;$USER_POSTCMD;';
alias precmd "$STARSHIP_PRECMD";
alias postcmd "$STARSHIP_POSTCMD";
